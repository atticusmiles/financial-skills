...
python3 skills/market-info/scripts/market-info.py '{"action":"quote","codes":["600519"]}'
```
...
python3 skills/stock-research/scripts/stock-research.py '{"action":"reports","code":"688017"}'
```
